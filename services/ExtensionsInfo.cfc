component {
	...
	variables.validExtensionFields = "author,email,category,support,description,mailinglist,name,documentation,image,label,type,railo_version,version,paypal,packaged-by,licenseTemplate,StoreID,auto_version_update";
