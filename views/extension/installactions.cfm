		...
		<div class="tabbable tabs-left">
			<ul class="nav nav-tabs">
				...
				<cfloop array="#rc.availableActions#" index="act">
					...
					<li class="#class#" style="text-transform:capitalize;<cfif hasContent>font-weight: bold;</cfif>"><a href="###act#" data-toggle="tab">#Replace(act, "_", " ", "all")#
                        <cfif Len(rc[act])><i class="icon-pencil"></i></cfif>
                        </a></li>
				</cfloop>
			</ul>
