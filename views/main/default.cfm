<cfoutput><div class="hero-unit">
	<h1>Railo Extension Builder</h1>
	<p>With the Railo Extension Builder you can build your own extensions that can be installed in the Railo Administrator</p>
...
<div class="span4">
	...
	as first class citizens amongst the other tags.
	</p>
	<p>
...
<div class="span4">
	...
	<p>
	So that you can install your extensions, we have provided a simple way for you to add the Builder's Extension provider
