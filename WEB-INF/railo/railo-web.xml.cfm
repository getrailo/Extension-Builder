<?xml version="1.0" encoding="UTF-8"?><railo-configuration label="extbuilder.local" version="2.0"><cfabort/>
...
<extensions><provider url="http://extbuilder.local/ExtensionProvider.cfc"/><extension author="Mark Drew" category="Demo" codename="" config="{'MIXED':{},'STEPS':[]}" created="{ts '2012-03-28 09:47:17'}" description="This is a demo extension just to see what happens when we save this" documentation="" forum="" id="FC9C1827-7583-4BB5-8076EADD81A32B21" image="" label="Nice Extension" mailinglist="" name="nice-extension" network="" provider="http://extbuilder.local/ExtensionProvider.cfc" support="" type="web" version="1.1.5" video=""/></extensions></railo-configuration>